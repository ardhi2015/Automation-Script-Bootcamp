...
class Landingpage(BaseTest):
    def test_landingpagee(self):
        ...
        with self.subTest(msg="download"):
            ...
            self.assertEqual("We Help You Make Your Dream Come True", element_text_download)
        ...
        with self.subTest(msg="tentang"):
            ...
            self.assertEqual("Zenia Indonesia 2020", element_text_tentang)

        self.landingpage.kalkulator()
        with self.subTest(msg="kalkulator"):
            element_text_kalkulator = self.landingpage.get_text(Locators.HASIL_KALKULATOR)
            self.assertEqual("Bersama Zenia kamu bisa beli rumah hingga\nharga:", element_text_kalkulator)
